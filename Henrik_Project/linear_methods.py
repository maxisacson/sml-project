...
parser = ArgumentParser(description = 'Regression using linear methods')
...
available_regressors = {
    ...
    'ridge': (
        'Ridge Regression',
        Ridge(alpha=arguments.alpha),
    ),
    # Yeah, LogisticRegression is a classifier, not a regressor...
    #'logistic': (
        #'Logistic Regression',
        #LogisticRegression(C=arguments.cost,
...
fig.savefig('{}_a{}.pdf'.format(arguments.regressor, arguments.alpha))
plt.show()

...
The dataset consist of simulated $pp$ collisions and $H^+\to\tau\nu$ decay. Each event is described by one set of observable variables and one set of unobservable variables.
